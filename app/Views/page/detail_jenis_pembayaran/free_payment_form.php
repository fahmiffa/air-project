                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a onclick="return confirm('Apakah anda sudah yakin akan menghapus data ini??')" href="/admin/detail_jenis_pembayaran/delete_bill_free_payment/<?php echo $value['id'] ?>" class="btn btn-danger btn-xs"> 
