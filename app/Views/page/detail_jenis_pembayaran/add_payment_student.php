<div class="row">
  <div class="col-12">
    <div class="card card-default">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form action="/admin/store_payment_clas/<?php echo $edit_data['id'] ?>" method="post">
          ...
          <div class="form-group row">
            <div class="col-2">
              <label for="" class="control-label">Siswa</label>
            </div>
            <div class="col-10">
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="number" class="form-control" placeholder="Masukan tanpa titik :10000">
            </div>
          </div>
