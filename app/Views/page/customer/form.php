      ...
      <div class="card-body">
        <form action="<?php echo isset($action)?$action:'' ?>" method="post">
            ...
            <div class="col-10">
              <select name="price_id" id="" class="form-control" required="">
                ...
                <?php foreach ($price as $key => $value): ?>
                  <option value="<?php echo $value['id'] ?>" <?php echo isset($edit_data['price_id'])?($edit_data['price_id'] == $value['id'])?'selected':'':'' ?>><?php echo $value['price_type']; ?></option>
                <?php endforeach ?>
              </select>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control" placeholder="Nama Pelanggan" required="" name="customer_name"
              value="<?php echo isset($edit_data['customer_name'])?$edit_data['customer_name']:'' ?>"> 
            </div>
          </div>
          <div class="form-group row">
            <div class="col-2">
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control" placeholder="PIC"  name="customer_pic"
              value="<?php echo isset($edit_data['customer_pic'])?$edit_data['customer_pic']:'' ?>"> 
            </div>
          </div>
          <div class="form-group row">
            <div class="col-2">
            ...
            <div class="col-10">
              <input type="text" class="form-control" placeholder="Nomor Polisi"  name="customer_nopol"
              value="<?php echo isset($edit_data['customer_nopol'])?$edit_data['customer_nopol']:'' ?>"> 
            </div>
          </div>
